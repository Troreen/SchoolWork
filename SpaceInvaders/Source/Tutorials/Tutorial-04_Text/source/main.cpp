...
void Go( void )
{
	Tga::LoadSettings(TGE_PROJECT_SETTINGS_FILE);
	{
		...
		Tga::Text myTextBombardiere("Text/BarlowSemiCondensed-Regular.ttf", Tga::FontSize_18);
		...
		Tga::Text myPlainText("Text/arial.ttf", Tga::FontSize_48);
		myPlainText.SetText(GetRandomText());

		Tga::Text myPlainTextInfo("Text/arial.ttf", Tga::FontSize_18);
		myPlainTextInfo.SetText("");

		Tga::Text myTextArial("Text/arial.ttf", Tga::FontSize_48);
