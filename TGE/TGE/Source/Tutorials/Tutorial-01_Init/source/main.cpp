...
void Go( void )
{
...

	{
		...
		cfg.myWindowSize = { static_cast<unsigned short>(windowWidth), static_cast<unsigned short>(windowHeight) };
		cfg.myRenderSize = { static_cast<unsigned short>(windowWidth), static_cast<unsigned short>(windowHeight) };
		cfg.myEnableVSync = false;
