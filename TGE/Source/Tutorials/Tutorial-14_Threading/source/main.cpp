...
{
	{
		...
		Tga::Text textEngineFPS("Text/BarlowSemiCondensed-Regular.ttf", Tga::FontSize_18);
		...
		Tga::Text textLoaderFPS("Text/BarlowSemiCondensed-Regular.ttf", Tga::FontSize_18);
		...
		Tga::Text textGameFPS("Text/BarlowSemiCondensed-Regular.ttf", Tga::FontSize_18);
		textGameFPS.SetText("");
...
void RunLoadingThread()
{
	...
	{
		myToLoadResources.push_back("sprites/tge_logo_b.dds");
	}
