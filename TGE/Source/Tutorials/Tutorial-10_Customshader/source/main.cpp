...
void Go( void )
{
	Tga::LoadSettings(TGE_PROJECT_SETTINGS_FILE);
	{
		...
		customShader.SetTextureAtRegister(Tga::Engine::GetInstance()->GetTextureManager().GetTexture("sprites/tge_logo_w.dds"), Tga::ShaderTextureSlot_1); // Add a texture
		...
		customShader2.SetTextureAtRegister(Tga::Engine::GetInstance()->GetTextureManager().GetTexture("sprites/tge_logo_w.dds"), Tga::ShaderTextureSlot_1); // Add a texture																																				   // Run PostInit to set all the data
		customShader2.Init("shaders/instanced_sprite_shader_vs", "shaders/custom_sprite_pixel_shader_2_ps");
		...
		customShader3.SetTextureAtRegister(Tga::Engine::GetInstance()->GetTextureManager().GetTexture("sprites/tge_logo_w.dds"), Tga::ShaderTextureSlot_1); // Add a texture																																				   // Run PostInit to set all the data
		customShader3.Init("shaders/instanced_sprite_shader_vs", "shaders/custom_sprite_pixel_shader_3_ps");
		...
		while (true)
		{
			...
			{
				Tga::Camera camera;
				float ratio = Tga::Engine::GetInstance()->GetRenderSizeRatioInversed();
