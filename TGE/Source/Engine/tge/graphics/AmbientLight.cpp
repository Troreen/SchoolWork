...
AmbientLight::AmbientLight(const Color& aColor, float aIntensity) : Light(Matrix4x4f{}, aColor, aIntensity), myType(AmbientLightType::UniformAboveHorizon) {}
AmbientLight::AmbientLight(AmbientLightType aType, const Color& aColor, float aIntensity) : Light(Matrix4x4f{}, aColor, aIntensity), myType(aType) {}
AmbientLight::AmbientLight(std::wstring& someCubemapLocation, const Color& aColor, float aIntensity) : Light(Matrix4x4f{}, aColor, aIntensity), myType(AmbientLightType::Custom) { SetCubemap(someCubemapLocation); }
