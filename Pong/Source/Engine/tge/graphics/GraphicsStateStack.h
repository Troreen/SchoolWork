...
namespace Tga
{
	...
	private:
		...
		ComPtr<ID3D11ShaderResourceView> myDefaultCubemap = nullptr;
		int myDefaultCubemapMipCount;

		ComPtr<ID3D11ShaderResourceView> myDefaultHorizonCubemap = nullptr;
		int myDefaultHorizonCubemapMipCount;
	};
}