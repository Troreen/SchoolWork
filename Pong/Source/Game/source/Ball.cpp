...
const Tga::Vector2f& Ball::GetPosition() const
{
    return myPosition;
}

const Tga::Vector2f& Ball::GetScreenResolution() const
{
...
{
    return 0.5f * (mySpriteInstance.mySize.x < mySpriteInstance.mySize.y ? mySpriteInstance.mySize.x : mySpriteInstance.mySize.y);
}