...
void Go(void)
{
	Tga::LoadSettings(TGE_PROJECT_SETTINGS_FILE);
	{
		...
		{ 
			modelFactory.GetAnimationPlayer("ani/sneak.fbx", model.GetModel()),
			modelFactory.GetAnimationPlayer("ani/idle.fbx", model.GetModel()),
			modelFactory.GetAnimationPlayer("ani/run.fbx", model.GetModel()),
			modelFactory.GetAnimationPlayer("ani/jump.fbx", model.GetModel())
		};
		...
		TextureResource* texture = Tga::Engine::GetInstance()->GetTextureManager().GetTexture("ani/atlas.tga");
